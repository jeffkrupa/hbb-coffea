...
class N2DDTProcessor(processor.ProcessorABC):
...
#            self._ak4tagBranch = 'btagDeepB'
        ...
        self.make_output = lambda: {
            ...
            'templates': hist.Hist(
                ...
                hist.Bin('n2ddt1',r'Jet N2DDT',50, -1, 1),
                hist.Bin('pt1', r'Jet $p_{T}$ [GeV]', 80, 400, 1200),
#                hist.Bin('msd1', r'Jet $m_{sd}$', 23, 40, 201),
                hist.Bin('rho1',r'Jet $\rho$', 20, -6, -2),
    ...
    def process_shift(self, events, shift_name):
        ...
        regions = {
            'signal-ggf': ['trigger','lumimask','metfilter','minjetkin','jetid','antiak4btagMediumOppHem','met','noleptons','notvbf'],
