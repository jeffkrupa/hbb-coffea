...
from boostedhiggs import N2DDTProcessor
...
if not os.path.isdir('outfiles-n2ddt/'):
    os.mkdir('outfiles-n2ddt')
...
with Client(cluster) as client:
    ...
    with performance_report(filename="dask-report.html"):
        ...
        for this_file in infiles:
            ...
            outfile = 'outfiles-n2ddt/'+str(year)+'_dask_'+index+'.coffea'
            ...
            p = N2DDTProcessor(year=year,jet_arbitration='ddb',ewkHcorr=True,systematics=False,skipJER=False)
